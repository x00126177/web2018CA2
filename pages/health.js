...
const url = `https://newsapi.org/v2/top-headlines?country=ie&category=health&apiKey=425415ed892a4afdabc0c8ecd315afe2`
...
const Health = props => (
    <div>
        <h2 className="title1">Health from {source.split("-").join(" ")}</h2>
      <div>
